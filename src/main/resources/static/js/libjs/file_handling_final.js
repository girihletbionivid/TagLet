...
function setSelectedValue(element) {
	...
	if (document.getElementById("valueSelectedDseq").value != "") {
		jarray["" + document.getElementById("valueSelectedDseq").value] = jarrayLoad[document
				.getElementById("valueSelectedDseq").value];
		element.innerHTML = ""
				+ document.getElementById("valueSelectedDseq").value;
		...
		// alert(typeOfReplacemnent+"ddddd==s=======>"+indexOfReplacement);
		// alert(typeOfReplacemnent+"ddddd==s=======>"+jsonArrayForIndexLocation[indexOfReplacement][0].single);
		if (jsonArrayForIndexLocation[indexOfReplacement] != undefined) {
			if (0 < jsonArrayForIndexLocation[indexOfReplacement].length) {
				// alert("ddddd=========>"+toString(jsonArrayForIndexLocation[indexOfReplacement][0].typeOfReplacemnent));
				jsonArrayForIndexLocation[indexOfReplacement][0][typeOfReplacemnent] = jarray[""
						+ document.getElementById("valueSelectedDseq").value];

			}
		}
		warningForFileOrFolders(element.id);
	} else {
...
function createFolder(thisDirectory) {
	...
	tempDiv.innerHTML = ""
			+ "<div class='col-sm-1'></div>"// onkeydown='return
			// validateKey(event);'
