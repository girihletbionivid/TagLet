...
function validateForm() 
{
	...
	if (userName.value == "") 
	{
		document.getElementById("waitingDivRegistration").innerHTML = "Enter your name to complete registration process, It is a mandatory field.";
	...
	if (myemail == "") {
		document.getElementById("waitingDivRegistration").innerHTML = "Enter your Email Id to complete registration process, It is a mandatory field.";
	...
	{
		document.getElementById("waitingDivRegistration").innerHTML = "Enter your designation to complete registration process, It is a mandatory field.";
	...
	if (institute.value == "") 
	{
		document.getElementById("waitingDivRegistration").innerHTML = "Enter your institute name to complete registration process, It is a mandatory field.";
	...
	if (address.value == "") 
	{
		document.getElementById("waitingDivRegistration").innerHTML = "Enter your address to complete registration process, It is a mandatory field.";
		address.style.border = '1px solid red';
		address.focus();
		return false;
	}
	address.style.border = '';
	institute.style.border = '';
...
function validateUserName() {
	...
	var emailId = document.getElementById("emailId");
	if (userName.value == "") {
		document.getElementById("waitingDivRegistration").innerHTML = "Name is a mandatory field.";
		userName.style.border = '1px solid red';
		userName.focus();
		return false;
	} else {
...
function requiredFields()
{
	...
	if (designation.value == "") 
	{
		document.getElementById("waitingDivRegistration").innerHTML = "Designation is a mandatory field.";
		designation.style.border = '1px solid red';
		designation.focus();
		return false;
	} 
	...
	{
		document.getElementById("waitingDivRegistration").innerHTML = "Institute name is a mandatory field.";
	...
	{
		document.getElementById("waitingDivRegistration").innerHTML = "Address is a mandatory field.";
...
function validateEmailId() 
{
	...
	if (myemail == "") 
	{
		document.getElementById("waitingDivRegistration").innerHTML = "E-mail Id is a mandatory field.";
		emailId.style.border = '1px solid red';
		emailId.focus();
		return false;
	} else {
...
function registerAdminWs() 
{
	...
	if (flage == true) 
	{
		...
		formData.append("confirmPassword", $("#repassword").val());
		...
		*/
		...
		document.getElementById("waitingDivRegistration").innerHTML = "<img src='images/spinner.gif' height='35px' width='35px' />";
			...
			if (xhr.readyState == 4) 
			{
				if (xhr.status == 200) 
				{
					if (response.userId != -1) 
					{
						...
						document.getElementById("aTagRegistrationRequest").disabled = 'false';
						document.getElementById("waitingDivRegistration").innerHTML = ""
								+ response.message;
...
function registerReset() {
	document.getElementById("aTagRegistrationRequest").disabled = 'true';
	$('#adminRegistrationFrom').trigger('reset');
	document.getElementById("waitingDivRegistration").innerHTML = "";
}
function loginReset() {
