...
public class SendEmail {
	...
	public Boolean send(String to, String userName,String userPassword) {
		...
		try {
			...
			message.setSubject("REG:SQIT_NEW_PASSWORD");

			// Now set the actual message
			message.setText("Hello "+userName+", your password is "
					+ userPassword);
